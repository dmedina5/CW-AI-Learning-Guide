...
const SECTIONS: Section[] = [
  ...
  { id: 'fundamentals', title: 'Fundamentals', href: '/road-to-agentic-engineering/fundamentals', tier: 'intermediate' },
  { id: 'workflows', title: 'Workflows', href: '/road-to-agentic-engineering/workflows', tier: 'expert' },
  { id: 'tips-tricks', title: 'Tips & Tricks', href: '/road-to-agentic-engineering/tips', tier: 'expert' },
  { id: 'use-cases', title: 'CW Use Cases', href: '/use-cases', tier: 'expert' },
  { id: 'cheatsheet', title: 'Cheatsheet', href: '/road-to-agentic-engineering/cheatsheet', tier: 'expert' },
