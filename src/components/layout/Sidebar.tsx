...
import {
  ...
  Briefcase, BookOpen, ChevronDown, LogOut, MonitorSmartphone, Layers,
} from 'lucide-react';
...
const ICON_MAP: Record<string, any> = {
  Home, Brain, MessageSquare, Wand2, Compass, Code2, Bot, Briefcase, BookOpen, MonitorSmartphone, Layers,
};
