...
const SEARCH_INDEX: SearchResult[] = [
  ...
  { title: 'GRIP Framework', href: '/prompt-engineering#grip', excerpt: 'Ground, Request, Intent, Proof. Replaces CRISP.', tier: 'intermediate', section: 'Prompt Engineering' },
  ...
  { title: 'Prompt Builder', href: '/prompt-builder', excerpt: 'Interactive tool to build structured prompts using the GRIP framework.', tier: 'intermediate', section: 'Tools' },
  { title: 'Right-Size Your Model', href: '/right-size-your-model', excerpt: 'Pick the smallest model that reliably does the job, and step up only when it struggles.', tier: 'intermediate', section: 'Right-Size Your Model' },
  { title: 'Right-Size This Task', href: '/right-size-your-model#right-sizer', excerpt: 'Five questions about your task, answered with a model, an effort level, and the reasoning.', tier: 'intermediate', section: 'Right-Size Your Model' },
  { title: 'The Claude Model Family', href: '/right-size-your-model#ladder', excerpt: 'Haiku 4.5, Sonnet 5, Opus 5, Fable 5 - cost and depth rise together as you climb.', tier: 'beginner', section: 'Right-Size Your Model' },
  { title: 'Effort Levels & ultracode', href: '/right-size-your-model#effort', excerpt: 'low, medium, high, xhigh, max - and ultracode, which is a mode not a level.', tier: 'intermediate', section: 'Right-Size Your Model' },
  { title: 'Token Cost Ladder', href: '/right-size-your-model#cost', excerpt: 'Sonnet costs ~3x Haiku per token, Opus ~5x, Fable ~10x. Effort multiplies the output side again.', tier: 'intermediate', section: 'Right-Size Your Model' },
  { title: 'Signs You Are Over-Buying', href: '/right-size-your-model#overbuying', excerpt: 'Opus to rephrase an email, max effort on formatting, ultracode because it feels important.', tier: 'intermediate', section: 'Right-Size Your Model' },
  { title: 'Escalate on Evidence', href: '/right-size-your-model#escalation', excerpt: 'Start cheap, turn the effort dial before changing the model, step up one rung at a time.', tier: 'expert', section: 'Right-Size Your Model' },
  ...
  { title: 'Installation Guide', href: '/road-to-agentic-engineering/installation', excerpt: 'Install Claude Code step by step on any platform.', tier: 'beginner', section: 'Road to Agentic Engineering' },
  { title: 'Fundamentals', href: '/road-to-agentic-engineering/fundamentals', excerpt: 'Mental models, CLAUDE.md, permission system.', tier: 'intermediate', section: 'Road to Agentic Engineering' },
  { title: 'Workflows', href: '/road-to-agentic-engineering/workflows', excerpt: 'Explore-Plan-Execute, Checklist-Driven, Supervisor patterns.', tier: 'expert', section: 'Road to Agentic Engineering' },
  { title: 'Tips & Tricks', href: '/road-to-agentic-engineering/tips', excerpt: 'Keyboard shortcuts, IDE integration, power-user techniques.', tier: 'expert', section: 'Road to Agentic Engineering' },
  { title: 'Cheatsheet', href: '/road-to-agentic-engineering/cheatsheet', excerpt: 'Quick reference for Claude Code commands and shortcuts.', tier: 'expert', section: 'Road to Agentic Engineering' },
