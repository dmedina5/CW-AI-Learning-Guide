...
const SEARCH_INDEX: SearchResult[] = [
  ...
  { title: 'Installation Guide', href: '/vibe-coding/installation', excerpt: 'Install Claude Code step by step on any platform.', tier: 'beginner', section: 'Vibe Coding' },
  ...
  { title: 'Workflows', href: '/vibe-coding/workflows', excerpt: 'Explore-Plan-Execute, Checklist-Driven, Supervisor patterns.', tier: 'expert', section: 'Vibe Coding' },
  ...
  { title: 'Cheatsheet', href: '/vibe-coding/cheatsheet', excerpt: 'Quick reference for Claude Code commands and shortcuts.', tier: 'expert', section: 'Vibe Coding' },
